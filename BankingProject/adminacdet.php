...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	$v4=$_POST['text4'];
	//echo $v1."  ".$v2;
	$sqlvar="insert into actypetap values('$v1','$v2','$v3',$v4)";
...
<tr> <td > <a href=adminmainpage.php>Go Back </a> </td> <td> <input type=submit name=Login  style="height: 45px; width: 150px"> </td> </tr>
